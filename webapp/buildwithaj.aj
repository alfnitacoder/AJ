...
if bw__pg == "ajlang-docs" then
  ...
  print "<p>Two documents cover everything:</p>"
  print "<li><b>AJLANG.md</b> - the language reference: syntax, packages (/opt/), all native builtins, limits and idioms.</li>"
  print "<li><b>AJLANGWEB.md</b> - the web framework: routing, request builtins, the web and db packages, deployment.</li>"
  print "<p>Both are in the repository <code class=\"inl\">docs/</code> folder, next to the interpreter source <code class=\"inl\">src/ajlang.c</code> (about 1300 lines of C - readable in one sitting).</p>"
end
