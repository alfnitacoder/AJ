...
// AJOS compatibility - types defined in ajos_compat.h
// Don't include system headers since we use -nostdinc
#include "ajos_compat.h"

// OpenBSD-specific type definitions (must be after ajos_compat.h)
#ifndef u_char
...
// OpenSSL not available in kernel
#ifndef WITH_OPENSSL
#define WITH_OPENSSL 0
#endif

// Stub OpenSSL types if not available
#if !WITH_OPENSSL
typedef void BIGNUM;
